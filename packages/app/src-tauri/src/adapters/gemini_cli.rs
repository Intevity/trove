...
/// block. `customAttributes` is intentionally a no-op for Gemini —
/// the upstream schema doesn't yet expose a clear path for resource
/// attributes; we'll add the field once Gemini's docs settle.
