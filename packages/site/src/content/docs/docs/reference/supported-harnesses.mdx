...
| Gemini CLI | Native OTel | Built-in OTel exporter |
...
<Aside type="note">
Sentinel — Intevity's companion AI-supervision tool — also speaks OTLP and can forward through Trove as a harness when both are installed. Tiers shift over time as upstream tools add native OTel support; the **Harnesses** tab always shows the live, detected tier for what's on your machine.
</Aside>
