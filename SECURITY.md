...
| ------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Harness configs     | The harness's existing settings file, to compute a diff and to detect Trove's own managed region                       | `~/.claude/settings.json`, `~/.gemini/antigravity-cli/hooks.json`, `~/.codex/config.toml`, `~/.qwen/settings.json`, `~/.config/opencode/opencode.json`, `~/.cursor/hooks.json` |
...
| Detection probes    | Existence/version of harness binaries on `PATH`; presence of standard config dirs; presence of known macOS app bundles | `which claude`, `which agy`, etc.; directory `stat` only                                                                                                                       |
...
| `~/.gemini/antigravity-cli/hooks.json` (`hooks` region)        | Register Trove's Antigravity hook (agy dropped native OTLP)                                                                                            | Yes                                                |
